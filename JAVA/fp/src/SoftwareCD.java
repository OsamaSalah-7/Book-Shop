...
public class SoftwareCD extends Item {

    public SoftwareCD(int item_id, String add_date, String title, String publisher,  boolean ebook, double b_cost, double e_cost, int number_of_copies) {
        super(item_id, add_date, title, publisher, ebook, b_cost, e_cost, number_of_copies);
    }
    ...
    public String toString() {
        return this.getTitle() + " by " + this.getDistributer() + " | Ebook availble: " + this.ebook_availble() + " | Number of copies availble: "
